...
Отдельная секция для обычных ботов (дикие и PMC).

- Для каждой роли укажите **количество** (0–20).
- Выберите **сложность** (normal / hard / impossible).
- Кнопка **«Заспавнить выбранных ботов»** спавнит указанное количество на текущей карте.
